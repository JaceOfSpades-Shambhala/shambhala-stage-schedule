...
Everything needed to continue this project from any computer. Written 2026-07-05, current release **v31**.
...
Every site release bumps ONE version number everywhere (currently 31). The pieces that must stay in sync:
...
```bash
sed -i 's/?v=31/?v=32/g; s/<!-- v31 -->/<!-- v32 -->/' index.html
sed -i 's/sw\.js?v=31/sw.js?v=32/; s/schedule-data\.js?v=31/schedule-data.js?v=32/' app.js
sed -i 's/stage-schedule-v31/stage-schedule-v32/; s/?v=31/?v=32/g' sw.js
```
