...
Everything needed to continue this project from any computer. Written 2026-07-05, current release **v72**.
...
Every site release bumps ONE version number everywhere (v72 at the time of writing). The pieces that must stay in sync:
...
v72 moves day navigation into the schedule-card header, relocates and enlarges the selected stage mark above the stage controls, and replaces the Hexadex button with a full-width collection strip showing found Owls without exposing the collection total.
