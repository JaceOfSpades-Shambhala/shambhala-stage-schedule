...
Everything needed to continue this project from any computer. Written 2026-07-05, current release **v52**.
...
Every site release bumps ONE version number everywhere (v52 at the time of writing). The pieces that must stay in sync:
...
```bash
sed -i 's/?v=50/?v=52/g; s/<!-- v50 -->/<!-- v52 -->/' index.html
sed -i 's/?v=50/?v=52/g' app.js styles.css manifest.webmanifest
sed -i 's/stage-schedule-v50/stage-schedule-v52/; s/?v=50/?v=52/g' sw.js
```
