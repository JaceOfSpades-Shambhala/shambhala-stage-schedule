...
Everything needed to continue this project from any computer. Written 2026-07-05, current release **v73**.
...
Every site release bumps ONE version number everywhere (v73 at the time of writing). The pieces that must stay in sync:
