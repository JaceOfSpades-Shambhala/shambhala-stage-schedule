...
Everything needed to continue this project from any computer. Written 2026-07-05, current release **v61**.
...
Every site release bumps ONE version number everywhere (v61 at the time of writing). The pieces that must stay in sync:
...
```bash
sed -i 's/?v=60/?v=61/g; s/<!-- v60 -->/<!-- v61 -->/' index.html
sed -i 's/?v=60/?v=61/g' app.js styles.css manifest.webmanifest hex-owl.js hex-owl-playground.html
sed -i 's/stage-schedule-v60/stage-schedule-v61/; s/?v=60/?v=61/g' sw.js
```
