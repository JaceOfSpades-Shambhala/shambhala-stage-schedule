...
Everything needed to continue this project from any computer. Written 2026-07-05, current release **v50**.
...
Every site release bumps ONE version number everywhere (v50 at the time of writing). The pieces that must stay in sync:
...
```bash
sed -i 's/?v=49/?v=50/g; s/<!-- v49 -->/<!-- v50 -->/' index.html
sed -i 's/?v=49/?v=50/g' app.js styles.css manifest.webmanifest
sed -i 's/stage-schedule-v49/stage-schedule-v50/; s/?v=49/?v=50/g' sw.js
```
