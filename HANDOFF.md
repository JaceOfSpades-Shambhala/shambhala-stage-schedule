...
Everything needed to continue this project from any computer. Written 2026-07-05, current release **v32**.
...
```bash
sed -i 's/?v=32/?v=33/g; s/<!-- v32 -->/<!-- v33 -->/' index.html
sed -i 's/sw\.js?v=32/sw.js?v=33/; s/schedule-data\.js?v=32/schedule-data.js?v=33/' app.js
sed -i 's/stage-schedule-v32/stage-schedule-v33/; s/?v=32/?v=33/g' sw.js
```
