const CACHE_NAME = "stage-schedule-v38";
const NETWORK_TIMEOUT_MS = 3500;
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=38",
  "./camp-location.js?v=38",
  "./schedule-data.js?v=38",
  "./app.js?v=38",
  "./planner.js?v=38",
  "./qrcode.js?v=38",
  "./hexlaces.js?v=38",
  "./install.js?v=38",
  "./wordmark.svg?v=38",
  "./fonts/InterVariable.woff2?v=38",
  "./stage-names/amp.png?v=38",
  "./stage-names/fractal-forest.png?v=38",
  "./stage-names/grove.png?v=38",
  "./stage-names/living-room.png?v=38",
  "./stage-names/pagoda.png?v=38",
  "./stage-names/secret-garden.png?v=38",
  "./stage-names/village.png?v=38",
