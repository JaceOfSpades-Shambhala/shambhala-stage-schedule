const CACHE_NAME = "stage-schedule-v44";
const NETWORK_TIMEOUT_MS = 3500;
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=44",
  "./camp-location.js?v=44",
  "./schedule-data.js?v=44",
  "./app.js?v=44",
  "./planner.js?v=44",
  "./qrcode.js?v=44",
  "./hexlaces.js?v=44",
  "./install.js?v=44",
  "./wordmark.svg?v=44",
  "./fonts/InterVariable.woff2?v=44",
  "./stage-names/amp.png?v=44",
  "./stage-names/fractal-forest.png?v=44",
  "./stage-names/grove.png?v=44",
  "./stage-names/living-room.png?v=44",
  "./stage-names/pagoda.png?v=44",
  "./stage-names/secret-garden.png?v=44",
  "./stage-names/village.png?v=44",
