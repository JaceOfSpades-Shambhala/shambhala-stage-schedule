const CACHE_NAME = "stage-schedule-v42";
const NETWORK_TIMEOUT_MS = 3500;
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=42",
  "./camp-location.js?v=42",
  "./schedule-data.js?v=42",
  "./app.js?v=42",
  "./planner.js?v=42",
  "./qrcode.js?v=42",
  "./hexlaces.js?v=42",
  "./install.js?v=42",
  "./wordmark.svg?v=42",
  "./fonts/InterVariable.woff2?v=42",
  "./stage-names/amp.png?v=42",
  "./stage-names/fractal-forest.png?v=42",
  "./stage-names/grove.png?v=42",
  "./stage-names/living-room.png?v=42",
  "./stage-names/pagoda.png?v=42",
  "./stage-names/secret-garden.png?v=42",
  "./stage-names/village.png?v=42",
