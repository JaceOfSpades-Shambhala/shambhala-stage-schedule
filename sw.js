const CACHE_NAME = "stage-schedule-v43";
const NETWORK_TIMEOUT_MS = 3500;
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=43",
  "./camp-location.js?v=43",
  "./schedule-data.js?v=43",
  "./app.js?v=43",
  "./planner.js?v=43",
  "./qrcode.js?v=43",
  "./hexlaces.js?v=43",
  "./install.js?v=43",
  "./wordmark.svg?v=43",
  "./fonts/InterVariable.woff2?v=43",
  "./stage-names/amp.png?v=43",
  "./stage-names/fractal-forest.png?v=43",
  "./stage-names/grove.png?v=43",
  "./stage-names/living-room.png?v=43",
  "./stage-names/pagoda.png?v=43",
  "./stage-names/secret-garden.png?v=43",
  "./stage-names/village.png?v=43",
