const CACHE_NAME = "stage-schedule-v40";
const NETWORK_TIMEOUT_MS = 3500;
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=40",
  "./camp-location.js?v=40",
  "./schedule-data.js?v=40",
  "./app.js?v=40",
  "./planner.js?v=40",
  "./qrcode.js?v=40",
  "./hexlaces.js?v=40",
  "./install.js?v=40",
  "./wordmark.svg?v=40",
  "./fonts/InterVariable.woff2?v=40",
  "./stage-names/amp.png?v=40",
  "./stage-names/fractal-forest.png?v=40",
  "./stage-names/grove.png?v=40",
  "./stage-names/living-room.png?v=40",
  "./stage-names/pagoda.png?v=40",
  "./stage-names/secret-garden.png?v=40",
  "./stage-names/village.png?v=40",
