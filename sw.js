const CACHE_NAME = "stage-schedule-v41";
const NETWORK_TIMEOUT_MS = 3500;
const ASSETS = [
  "./",
  "./index.html",
  "./styles.css?v=41",
  "./camp-location.js?v=41",
  "./schedule-data.js?v=41",
  "./app.js?v=41",
  "./planner.js?v=41",
  "./qrcode.js?v=41",
  "./hexlaces.js?v=41",
  "./install.js?v=41",
  "./wordmark.svg?v=41",
  "./fonts/InterVariable.woff2?v=41",
  "./stage-names/amp.png?v=41",
  "./stage-names/fractal-forest.png?v=41",
  "./stage-names/grove.png?v=41",
  "./stage-names/living-room.png?v=41",
  "./stage-names/pagoda.png?v=41",
  "./stage-names/secret-garden.png?v=41",
  "./stage-names/village.png?v=41",
