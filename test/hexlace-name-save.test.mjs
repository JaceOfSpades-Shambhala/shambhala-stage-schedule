...
test("saving a new sharing name stops before creation when no sets are saved", async () => {
  ...
  assert.match(source.slice(guard, create), /Save at least one set before choosing your sharing name\./);
