(() => {
  ...
  function setPosterArt(stageLabel) {
    ...
    art.src = `stage-names/${appState.stage}.png?v=41`;
    art.alt = stageLabel;
  ...
  const SCHEDULE_ASSET = "schedule-data.js?v=41";
  ...
  if ("serviceWorker" in navigator) window.addEventListener("load", () => {
    navigator.serviceWorker.register("sw.js?v=41").then(registerPeriodicSync).catch(() => {});
  });
})();
