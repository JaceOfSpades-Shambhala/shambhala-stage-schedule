(() => {
  ...
  function setPosterArt(stageLabel) {
    ...
    art.src = `stage-names/${appState.stage}.png?v=42`;
    art.alt = stageLabel;
  ...
  const SCHEDULE_ASSET = "schedule-data.js?v=42";
  ...
  if ("serviceWorker" in navigator) window.addEventListener("load", () => {
    navigator.serviceWorker.register("sw.js?v=42").then(registerPeriodicSync).catch(() => {});
  });
})();
