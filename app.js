(() => {
  ...
  function setPosterArt(stageLabel) {
    ...
    art.src = `stage-names/${appState.stage}.png?v=43`;
    art.alt = stageLabel;
  ...
  const SCHEDULE_ASSET = "schedule-data.js?v=43";
  ...
  if ("serviceWorker" in navigator) window.addEventListener("load", () => {
    navigator.serviceWorker.register("sw.js?v=43").then(registerPeriodicSync).catch(() => {});
  });
})();
